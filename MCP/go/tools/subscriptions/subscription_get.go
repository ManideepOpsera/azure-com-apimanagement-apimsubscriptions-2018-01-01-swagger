...
func Subscription_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSubscription_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_subscriptions_sid",
		mcp.WithDescription("Gets the specified Subscription entity."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscription_getHandler(cfg),
	}
}
