...
func Subscription_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SubscriptionUpdateParameters
...
func CreateSubscription_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_subscriptions_sid",
		mcp.WithDescription("Updates the details of a subscription specified by its identifier."),
		...
		mcp.WithObject("properties", mcp.Description("Input parameter: Parameters supplied to the Update subscription operation.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Subscription_updateHandler(cfg),
	}
}
